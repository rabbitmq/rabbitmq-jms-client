...
set TESTCLASSPATH=%TESTCLASSPATH%;%JMSCTS_HOME%\lib\jmscts-0.5-b2.jar
...
@echo on
%_EXECJAVA% %JAVA_OPTS% %JAVAX_OPTS% -classpath "%TESTCLASSPATH%" -Djava.security.manager -Djava.security.policy="%POLICY_FILE%" -Djmscts.home="%JMSCTS_HOME%" %MAINCLASS% %ACTION% %CMD_LINE_ARGS% 
