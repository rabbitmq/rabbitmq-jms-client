...
rem
rem
rem $Id: send.bat,v 1.1 2003/12/28 14:03:13 tanderson Exp $
rem ---------------------------------------------------------------------------
...
set CLASSPATH=%CLASSPATH%;%JMSCTS_HOME%\lib\jmscts-0.5-b2.jar
...
set MAINCLASS=org.exolab.jmscts.tools.send.Main
