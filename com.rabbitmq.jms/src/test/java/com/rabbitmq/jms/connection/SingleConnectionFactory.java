...
package com.rabbitmq.jms.connection;
 ...
 * {@link com.rabbitmq.client.Connection#close()}.
 * 
 * @author Mark Fisher
 * @author Mark Pollack
 * @author Dave Syer
...
public class SingleConnectionFactory extends AbstractConnectionFactory {
    ...
    /**
     * Create a Connection. This implementation just delegates to the underlying
     * Rabbit ConnectionFactory. Subclasses typically will decorate the result
    ...
    /**
     * Wrap a raw Connection with a proxy that delegates every method call to it
     * but suppresses close calls. This is useful for allowing application code
     * to handle a special framework Connection just like an ordinary Connection
