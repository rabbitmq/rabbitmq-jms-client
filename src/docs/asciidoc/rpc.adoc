...
https://docs.spring.io/spring/docs/5.1.0.RELEASE/spring-framework-reference/integration.html#jms[Spring JMS]
...
See https://github.com/rabbitmq/rabbitmq-jms-client/blob/main/src/test/java/com/rabbitmq/integration/tests/RpcSpringJmsIT.java[this test]
